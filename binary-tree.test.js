...
xdescribe("serialize and deserialize", function () {
  let myTree;
  ...
  it("is a pure function", function () {
    ...
    let myTreeCopy = new BinaryTree(root);
...
xdescribe("lowestCommonAncestor", function () {
